...
const updateUser = async function(req, res) {
    ...
    let updatedUserMobileNumber = await userMobile.findOneAndUpdate({_id: userId},{$set: {mobile: userUpdatedNumber},upsert: true, new: true});
    res.send({status: true, data: updatedUserMobileNumber})
}

const isDeleteUser = async function(req, res) {
    let isDeletedId = req.param.userId;
